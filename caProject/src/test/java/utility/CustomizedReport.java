...
public class CustomizedReport implements IReporter {
	private static final String emailableReportTemplateFile = "../caProject/test-output/customize-emailable-report-template.html";
	...
	private String readEmailabelReportTemplate() throws IOException
	{
		StringBuffer retBuf = new StringBuffer();
